...
urlpatterns = patterns('',
	...
	url(r'^users/search/(?P<criteria>[\w@.]+)/(?P<page>\d*)$', views.search_user, name='search_user'),
	url(r'^users/search/(?P<criteria>[\w@.]+)$', views.search_user, name='search_user'),
	url(r'^users/search$', views.search_user, name='search_user_p'),
